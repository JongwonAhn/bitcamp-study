// 멀티 스레딩(비동기 프로그래밍)의 문제점 - 사례 2의 문제해결
...
public class Exam0220 {
  ...
  static class Account {
    ...
    // => 여러 스레드가 동시에 접근했을 때 문제가 발생하지 않는 코드에 대해서도
    //    synchronized 사용한다면 실행 속도가 떨어질 것이다.
    //  -> 왜? 
    //    한번에 한 스레드만 순차적으로 접근하기 때문이다.
    //
    // 이렇게 크리티컬 섹션에 동시에 접근하지 못하게 하는 기법을
  ...
  public static void main(String[] args) {
    ...
    // => 생활 예) 선풍기 풍량세기 선택, 라디오 채널 및 TV채널 선택
    // => semaphore(1)과 같다.
